...
class _SettingPageState extends State<SettingPage> {
  ...
  String region = Hive.box('settings')
      .get('region', defaultValue: 'United States') as String;
  bool useProxy =
  ...
  List preferredLanguage = Hive.box('settings')
      .get('preferredLanguage', defaultValue: ['Enlgish'])?.toList() as List;
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                Navigator.pop(context);
                                                launch(
                                                  'https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&su=Regarding+Mobile+App&to=lmgxenon@gmail.com',
                                                );
                                              },
                                            ),
                                            Text(
